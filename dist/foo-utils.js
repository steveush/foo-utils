...
FooUtils.$, FooUtils, FooUtils.is, FooUtils.fn, FooUtils.str);
...
(function ($, _, _is, _obj, _fn) {
  ...
  _.Class.extend = function (definition) {
    ...
    function Class() {
      if (!_is.fn(this.construct)) throw new SyntaxError('FooUtils.Class objects must be constructed with the "new" keyword.');
...
FooUtils.$, FooUtils, FooUtils.is, FooUtils.obj, FooUtils.fn);
...
(function ($, _, _is, _fn, _obj) {
  ...
  /** @lends FooUtils.ClassRegistry.prototype */
  {
    /**
     * @ignore
     * @constructs
...
(function (_, _is, _str) {
  ...
  /** @lends FooUtils.Event.prototype */
  {
    /**
     * @ignore
     * @constructs
    ...
    construct: function construct(type) {
      if (_is.empty(type)) throw new SyntaxError('FooUtils.Event objects must be supplied a `type`.');
  ...
  /** @lends FooUtils.EventClass.prototype */
  {
    /**
     * @ignore
     * @constructs
...
FooUtils, FooUtils.is, FooUtils.str);
...
FooUtils.$, FooUtils, FooUtils.is, FooUtils.fn);
